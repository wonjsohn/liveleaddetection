...
class MAGIcTableGUI_Runner(QDialog):
    def __init__(self):
        ...
        self.path_comboBox.currentIndexChanged[str].connect(self.path_selectionchange)
    ...
    def path_selectionchange(self, i):
        ...
        print("Current path index", i, "selection changed ", self.path_comboBox.currentText())
    ...
    def loadSettings(self):
        ...
        if self.settings.allKeys(): # if keys exist
            ...
            print('path_combobox value: ', path_comboBox)
            ...
            self.path_comboBox.setProperty("currentText", path_comboBox)
