...
import time
from shape_detection import detect_circle, detect_obstacles, detectShapesInTable, justReturnSelectedImage
import pickle
import numpy as np
import glob
import os
...
def take_snapshot(args, width, centerx, centery, table_halfw, table_halfh, timeTag, camera_port, screen_w,screen_h):
    ...
    cv2.putText(instructions, '1. Press Space Bar to take a snapshot',
                (10, 200),
                font,
                fontScale,
                fontColor,
    ...
    cv2.putText(instructions, '3. Once you are satisfied ',
                (10, 400),
                font,
                fontScale,
                fontColor,
...
#        frame = cv2.resize(frame, (width,height))
        ...
        if k%256 == 27:
            ...
            """ just returm the still frame that was captured. """
            shot_frame = justReturnSelectedImage(img_name,  centerx, centery, table_halfw, table_halfh)
